...
<template>
    <div class="absolute flex items-start pt-40 justify-center w-full min-h-screen bg-gray-100 p-4">
        <!-- Card container for the form -->
        <div
            class="w-full top-20 max-w-sm p-8 bg-white rounded-2xl shadow-xl transition-all duration-300 ease-in-out transform hover:scale-[1.02]">
                ...
                <form @submit.prevent="handleLogin" class="space-y-6">
                    <div>
                        ...
                        <input id="login-email" type="email" v-model="loginForm.email" placeholder="you@example.com"
                            required
                            class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200" />
                    </div>
                    <div>
